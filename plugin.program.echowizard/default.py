...
NOTICE              = xbmc.translatePath(os.path.join('special://home/addons/' + addon_id, 'resources/files/notice.txt'))
...
if mode==None or url==None or len(url)<1:
	try:
		...
		Common.TextBox('[COLOR yellowgreen][B]ECHO Wizard[/B][/COLOR]',"%s" % msg)
		quit()
	except: pass        
elif mode>=1:
	try:
