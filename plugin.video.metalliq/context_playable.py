        ...
        if xbmc.getCondVisibility('Container.Content(movies)') == True:
            ...
            if xbmc.getInfoLabel('ListItem.TVShowTitle'):
                if xbmc.getCondVisibility('Container.Content(tvshows)'): url = "plugin://{0}/tv/play_by_name_only/{1}/en".format(pluginid, xbmc.getInfoLabel('ListItem.TVShowTitle'))
                    ...
                    if xbmc.getInfoLabel('ListItem.Season') and xbmc.getInfoLabel('ListItem.Episode'): url = "plugin://{0}/tv/play_by_name/{1}/{2}/1/context".format(pluginid, xbmc.getInfoLabel('ListItem.TVShowTitle'), xbmc.getInfoLabel('ListItem.Season'), xbmc.getInfoLabel('ListItem.Episode'))
                    else: url = "plugin://{0}/tv/play_by_name_only/{1}/en".format(pluginid, xbmc.getInfoLabel('ListItem.TVShowTitle'))
                elif xbmc.getCondVisibility('Container.Content(episodes)'):
                    if xbmc.getInfoLabel('ListItem.Season') and xbmc.getInfoLabel('ListItem.Episode'): url = "plugin://{0}/tv/play_by_name/{1}/{2}/{3}/context".format(pluginid, xbmc.getInfoLabel('ListItem.TVShowTitle'), xbmc.getInfoLabel('ListItem.Season'), xbmc.getInfoLabel('ListItem.Episode'))
                    else: url = "plugin://{0}/tv/play_by_name_only/{1}/en".format(pluginid, xbmc.getInfoLabel('ListItem.TVShowTitle'))
