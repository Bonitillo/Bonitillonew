...
class Mobileclient(_Base):
    ...
    def get_stations(self, station_id):
        res = self._make_call(mobileclient.GetStations, station_id)

        return res['stations']

    def get_config(self):

        return self._make_call(mobileclient.Config)

    def get_new_releases(self, num_items=50, genre=None):
