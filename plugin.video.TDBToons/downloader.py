...
baseurl         = base64.b64decode(b'aHR0cDovL2FscGhhYWRkb24uY28udWsvdGhlYWxwaGEvbWVudTIueG1s')
ENCRYPT         = 'VGhpcy/BpcyB0aGUg/YWxwaGEgY/WRkb24gbm9/0IHlvdXJzI/HBpc3Mgb2ZmIHB/sZWFzZQ=='
enc1,enc2,enc3,enc4,enc5,enc6,enc7 = ENCRYPT.split('/')
ENC_STRING      = enc1 + enc2 + enc3 + enc4 + enc5 + enc6 + enc7
ALMOST          = base64.b64encode(ENC_STRING)
USER_AGENT      = base64.b64decode(ALMOST)
...
AddonTitle="[B][COLOR ghostwhite]Team[/COLOR] [COLOR dodgerblue]TDB[/COLOR] [COLOR lightsteelblue]Downloader[/COLOR][/B]"
