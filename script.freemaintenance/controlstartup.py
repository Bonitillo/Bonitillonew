...
addonPath = os.path.join(os.path.join(xbmc.translatePath('special://home'), 'addons'),'script.freemaintenance')

mediaPath = os.path.join(addonPath, 'media')
databasePath = xbmc.translatePath('special://database')
THUMBS    =  xbmc.translatePath(os.path.join('special://home/userdata/Thumbnails',''))

addon_id = 'script.freemaintenance'
...
def clearCache():
    ...
    xbmc.executebuiltin('XBMC.Notification(%s, %s, %s, %s)' % ('Maintenance' , 'Auto Clean Completed' , '3000', iconpath))    
