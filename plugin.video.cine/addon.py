...
def get_categories():
    ...
    categories.append({'title':'Últimas 2016-2017',   'action':'ultim',  'ico':'bus'})
    categories.append({'title':'Últimas hasta 2015',  'action':'ultim2', 'ico':'bus'})
...
def dolist(rows=[],tipo2=False,zid=''):
    ...
    for row in rows:
        ...
        list_item.addStreamInfo('audio',{'language': 'es'})
